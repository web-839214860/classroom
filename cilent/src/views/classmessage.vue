<template>
    ...
    <div class="classroom">
        ...
        <div class="crumbs">
            ...
            <el-breadcrumb separator="/">
             ...
             <el-breadcrumb-item>课室信息</el-breadcrumb-item>
    ...
    <div class="searchbox">
      <el-input  v-model="searchTableInfo" placeholder="请输入课室名称(小写字母)" style="width:240px"></el-input>
    </div>
             ...
             <el-table-column label="课室ID" prop="c_id" width="80" align="center">
             </el-table-column>
             ...
             <el-table-column label="课室地点" prop="c_position" width="80" align="center">
             </el-table-column>

            <el-table-column label="操作" prop="doit" width="290" align="center">
                <template slot-scope="scope"> 
                <el-button size="small" type="danger" @click="deleteclassroom(scope.row.c_id)">删除</el-button>
                </template>
             </el-table-column>
 ...
 showMessage(type,message){
       this.$message({
        ...
        handleClassList(){
            ...
            this.$api.classroom.getclassroominfo().then(res =>{
            if(res.code==1){
        ...
        deleteclassroom(val){
            this.$api.classroom.deleteclassroom(val).then(res =>{
            if(res.code==1){
